        ...
        <section id="pricing" ref={sectionRef} className="py-16 relative overflow-hidden bg-slate-100/80">
            ...
            <div className="container px-4 mx-auto relative z-10">
                <div className="max-w-3xl mx-auto text-center mb-10">
                    <span className="inline-block px-3 py-1 text-xs font-semibold tracking-wider text-indigo-600 uppercase bg-white rounded-full mb-3 border border-indigo-100 shadow-sm">Join Our Program</span>
                        ...
                        >
                            ...
                            <div className={`p-6 ${plan.highlighted ? 'bg-gradient-to-br from-indigo-50 to-violet-50 border-b border-indigo-100/50' : 'bg-white border-b border-gray-100'}`}>
                                <div className="flex items-center mb-3">
                                    <div className={`flex-shrink-0 p-2 rounded-full bg-gradient-to-br ${plan.iconGradient} bg-opacity-50 mr-3`}>
                                        <div className={`flex items-center justify-center h-6 w-6 rounded-full text-white bg-gradient-to-br ${plan.gradientFrom} ${plan.gradientTo}`}>
                                            {plan.icon}
                                        </div>
                                    </div>
                ...
                <div className="max-w-3xl mx-auto mt-16 text-center">
                    <div className="p-6 rounded-xl bg-white border border-slate-200 shadow-sm">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div className="p-4 rounded-lg bg-gradient-to-br from-indigo-50 to-violet-50 border border-indigo-100/50">
                                <div className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-violet-600 mb-2">90%+</div>
                                <p className="text-sm text-gray-700">Direct hiring by HitoAI Limited or industry partners</p>
                            </div>

                            <div className="p-4 rounded-lg bg-gradient-to-br from-indigo-50 to-violet-50 border border-indigo-100/50">
                                <div className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-violet-600 mb-2">80-90%</div>
                                <p className="text-sm text-gray-700">Certificate of Achievement and job support through our network</p>
                            </div>

                            <div className="p-4 rounded-lg bg-gradient-to-br from-indigo-50 to-violet-50 border border-indigo-100/50">
                                <div className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-violet-600 mb-2">70-80%</div>
                                <p className="text-sm text-gray-700">Eligible for an internship upon written request</p>
                            </div>
                        </div>

                        <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-4">
                            <Button
                                className="whitespace-nowrap text-sm bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-700 hover:to-violet-700"
                                variant="default"
                            >
                                Apply Now
                            </Button>
                            <Button
                                className="whitespace-nowrap text-sm border-indigo-600 text-indigo-600 hover:bg-indigo-50"
                                variant="outline"
                            >
